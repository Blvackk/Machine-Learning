...
dataset = pd.read_csv(r"D:\NIT\1. NIT_Batches\1. MORNING BATCH\N_Batch -- 10.40AM _ Sep26\4. June\2nd- Decission Tree\5. DECESSION TREE CODE\Social_Network_Ads.csv")
